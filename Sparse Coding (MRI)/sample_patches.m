...
%     lImG2xz = (lImG2xz / max(lImG2xz(:)))*100;      
    ...
    for ii = 1:patch_num
        ...
        Lpatch1 = lImG1xy(row:row+patch_size-1, col:col+patch_size-1, page:page+patch_size-1);
        Lpatch2 = lImG1yz(row:row+patch_size-1, col:col+patch_size-1, page:page+patch_size-1);
        Lpatch3 = lImG1xz(row:row+patch_size-1, col:col+patch_size-1, page:page+patch_size-1);
        Lpatch4 = lImG2xy(row:row+patch_size-1, col:col+patch_size-1, page:page+patch_size-1);
        Lpatch5 = lImG2yz(row:row+patch_size-1, col:col+patch_size-1, page:page+patch_size-1);
        Lpatch6 = lImG2xz(row:row+patch_size-1, col:col+patch_size-1, page:page+patch_size-1);
