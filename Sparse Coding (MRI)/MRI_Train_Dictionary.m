...
% Normalization will be performed in function train_coupled_dict()
...
lambda     = 0.025;         % sparsity regularization, original value 0.15
patch_size = 10;            % image patch size
patch_num  = 20000;        % number of patches to sample, original value 100000
