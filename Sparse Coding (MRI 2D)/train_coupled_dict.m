...
% addpath(genpath('RegularizedSC_General'));
...
% idx = randperm(size(X, 2)); % unused variable, 2017/01/07
...
% patch_size = sqrt(size(Dh, 1)); % unused variable, 2017/01/07

% comment on 2017/01/07
